...
CREATE TABLE "users_stats" ( "id" TEXT NOT NULL,
...
CREATE TABLE "tags_stats" ( "id" TEXT NOT NULL,
...
ALTER TABLE "users_stats" ADD CONSTRAINT "users_stats_user_id_fkey"
...
ALTER TABLE "tags_stats" ADD CONSTRAINT "tags_stats_tag_name_fkey"
