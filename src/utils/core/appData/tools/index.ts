import cgArtsTools from './cg-arts';
import convertersAndTransformersTools from './converters-and-transformers';

const toolsData = {
	relativePath: 'tools',
	title: 'Converters and Generators for Text and Art Tools',
	shortTitle: 'Converters and Generators Tools',
	description:
	...
	faqs: [
		{
			question: 'What are the available tools on this page?',
			answer:
		...
		},
		{
			...
			answer: 'Yes, all of the tools on this page are free to use.'
		},
		{
			question: 'Are there any limitations to these tools?',
			answer:
		...
		{
			question: 'How can I share my generated output?',
			answer:
		...
		{
			question:
				'Are there any limitations to the size or length of the input that I can use with the converters and transformers?',
			answer:
		...
		{
			question: 'How do I know if my output is correct or accurate?',
			answer:
		...
		{
			question:
				'Can I customize the parameters or input values for the converters and transformers?',
			answer:
		...
		{
			question:
				'How do I troubleshoot any issues or problems that I encounter while using the converters and transformers?',
			answer:
	...
	pages: [convertersAndTransformersTools, cgArtsTools]
};
