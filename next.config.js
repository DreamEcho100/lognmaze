...
module.exports = (phase) => {
	...
	if (phase === PHASE_DEVELOPMENT_SERVER) {
		...
		env = {
			...
			FRONT_END_ROOT_URL: 'mazecode-using-postgresql-as-a-database.vercel.app', // baseUrl, // process.env.PRODUCTION_FRONT_END_ROOT_URL,
			BACK_END_ROOT_URL: 'mazecode-using-postgresql-as-a-database.vercel.app', // baseUrl, // process.env.PRODUCTION_BACK_END_ROOT_URL,
			FRONT_END_DOMAIN: 'mazecode-using-postgresql-as-a-database.vercel.app', // baseUrl, // process.env.PRODUCTION_FRONT_END_DOMAIN,
