...
module.exports = (phase) => {
	...
	if (phase === PHASE_DEVELOPMENT_SERVER) {
		env = {
			...
			FRONT_END_ROOT_URL: baseUrl, // process.env.DEVELOPMENT_FRONT_END_ROOT_URL,
			BACK_END_ROOT_URL: baseUrl, // process.env.DEVELOPMENT_BACK_END_ROOT_URL,
			FRONT_END_DOMAIN: baseUrl, // process.env.DEVELOPMENT_FRONT_END_DOMAIN,
		...
		env = {
			...
			FRONT_END_ROOT_URL: baseUrl, // process.env.PRODUCTION_FRONT_END_ROOT_URL,
			BACK_END_ROOT_URL: baseUrl, // process.env.PRODUCTION_BACK_END_ROOT_URL,
			FRONT_END_DOMAIN: baseUrl, // process.env.PRODUCTION_FRONT_END_DOMAIN,
